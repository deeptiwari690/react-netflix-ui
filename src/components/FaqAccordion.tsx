...
export function FaqAccordion() {
  return (
    <section className="o-section c-faq-accordion" aria-labelledby="faq-accordion-title">
      <h2 className="c-faq-accordion__title" id="faq-accordion-title">
        Frequently Asked Questions
      </h2>
      <ul className="c-faq-accordion__list">
        {faqItems.map((item) => (
